...
.cta-section {
  background: linear-gradient(135deg, var(--color-bisque) 0%, var(--color-bisque-light) 100%);
...
.btn:hover {
  ...
  box-shadow: 0 8px 25px rgba(151, 40, 5, 0.2);
}

.form-control {
  border-radius: 50px;
  border: none;
  box-shadow: 0 4px 15px rgba(151, 40, 5, 0.1);
}

.form-control:focus {
  box-shadow: 0 4px 20px rgba(151, 40, 5, 0.15);
